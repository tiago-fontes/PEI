...
INSERT INTO car (id, sensor_id, status, license_plate, brand, fuel, model, number_of_doors, number_of_seats, transmission, year, user_id) VALUES (1, 1, "online", "AA-11-AA", "BMW", "Diesel", "M4", 5, 5, "Manual", 2017, 1);
...
INSERT INTO car (id, sensor_id, status, license_plate, brand, fuel, model, number_of_doors, number_of_seats, transmission, year, user_id) VALUES (2, 2, "online", "BB-22-BB", "Renault", "Diesel", "Megane", 5, 5, "Manual", 2015, 2);
INSERT INTO car (id, sensor_id, status, license_plate, brand, fuel, model, number_of_doors, number_of_seats, transmission, year, user_id) VALUES (3, 3, "online", "CC-22-CC", "Alfa Romeo", "Diesel", "Stelvio", 5, 5, "Manual", 2015, 2);
INSERT INTO car (id, sensor_id, status, license_plate, brand, fuel, model, number_of_doors, number_of_seats, transmission, year, user_id) VALUES (4, 4, "online", "DD-22-DD", "Alfa Romeo", "Diesel", "Giulia", 5, 5, "Manual", 2015, 2);
INSERT INTO car (id, sensor_id, status, license_plate, brand, fuel, model, number_of_doors, number_of_seats, transmission, year, user_id) VALUES (5, 4, "online", "EE-22-EE", "Alfa Romeo", "Diesel", "Giulia", 5, 5, "Manual", 2015, 2);
...
INSERT INTO car (id, sensor_id, status, license_plate, brand, fuel, model, number_of_doors, number_of_seats, transmission, year, user_id) VALUES (6, 2, "online", "66-ZZ-66", "Honda", "Diesel", "NSX", 3, 2, "Manual", 2015, 3);
